      ...
      <v-row class="padding">
        ...
        <v-col cols="6" lg="6" class="left">
          ...
          <LineChart
            ...
            :dailyHour="trends[index].daily[index2].hour"
            x-axis="Hour"
            :index="index2"
        ...
        <v-col cols="6" lg="6" class="right">
          ...
          <LineChart
            id="weekly"
            :dailyMax="trends[index].weekly[index2].max"
            :dailyMin="trends[index].weekly[index2].min"
            :dailyAvg="trends[index].weekly[index2].avg"
            :dailyHour="trends[index].weekly[index2].day"
            x-axis="Day"
            :index="index2"
          />
        </v-col>
